...
public class FileInputReader extends AbstractBoundedReader<IndexedRecord> {
    ...
    public boolean advance() throws IOException {
        ...
        if (hasMore) {
            ...
            IndexedRecord outOfBandRecord = new GenericData.Record(FileInputProperties.outOfBandSchema);
    ...
    @Override
    public FileInputSource getCurrentSource() {
        return (FileInputSource) super.getCurrentSource();
    }
    ...
    private Schema getRootSchema() {
        if (rootSchema == null) {
            if (runtimeSchema == null) {
                ...
                rootSchema = RootSchemaUtils.createRootSchema(runtimeSchema, FileInputProperties.outOfBandSchema);
            }
        }
        return rootSchema;
    }
