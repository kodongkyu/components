...
import org.talend.components.file.FileInputFamilyDefinition;
...
public class FileInputTest {
    ...
    public ComponentService getComponentService() {
        if (componentService == null) {
            ...
            testComponentRegistry.registerComponentFamilyDefinition(new FileInputFamilyDefinition());
    ...
    public void testFileInputRuntime() throws Exception {
        ...
        File tempFile = File.createTempFile("FileInputTestFile", ".txt");
        try {
            ...
            FileInputSource source = new FileInputSource();
            source.initialize(null, props);

            FileInputReader reader = source.createReader(null);
