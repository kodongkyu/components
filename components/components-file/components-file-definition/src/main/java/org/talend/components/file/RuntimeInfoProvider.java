...
public final class RuntimeInfoProvider {
    ...
    public static final String RUNTIME_CLASS_NAME = "org.talend.components.file.runtime.reader.FileInputSource"; //$NON-NLS-1$
    ...
    /**
     * Returns instance of {@link RuntimeInfo} for Input component with runtime class name FileInputSource
     * 
